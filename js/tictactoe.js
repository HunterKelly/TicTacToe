...
function checkWinConditions() {
    ...
    //X 6, 4, 2 condition.
    else if (arrayIncludes('6X', '4X', '2X')) {drawWinLine(100, 508, 520, 100) }
...
function audio(audioURL) {
    //We create a new audio ovhect and we pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line access out html canvas element
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the start of a lines y axes is.
        y1 = coordY1,
